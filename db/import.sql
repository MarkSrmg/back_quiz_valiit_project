...
INSERT INTO public.quiz (id, user_id, name, status, is_public, required_count, type, timestamp) VALUES (DEFAULT, 2, 'public quiz', 'A', true, 2, 'F', '2023-02-07 14:37:04.000000');
INSERT INTO public.quiz (id, user_id, name, status, is_public, required_count, type, timestamp) VALUES (DEFAULT, 1, 'flashy', 'A', false, 2, 'F', '2023-02-07 14:36:14.000000');
INSERT INTO public.quiz (id, user_id, name, status, is_public, required_count, type, timestamp) VALUES (DEFAULT, 1, 'quizzy', 'A', false, 2, 'Q', '2023-02-07 14:38:08.000000');
